                ...
                children: [
                  ScaleTransition(
                    ...
                    child: Container(
                      ...
                      child: const Icon(Icons.air_rounded, size: 64, color: Color(0xFF4CAF82)),
                    ),
                  ),
                  ...
                  FilledButton.icon(
                    ...
                    style: FilledButton.styleFrom(backgroundColor: const Color(0xFF4CAF82)),
                  ),
                ],
              ),
            ),
                ...
                child: Row(
                  children: [
                    CircleAvatar(
                      ...
                      child: Icon(ex['icon'] as IconData, color: ex['color'] as Color),
                    ),
